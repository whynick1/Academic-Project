...
def _grab_tile(lat, lon, zoom, maptype, _TILESIZE, sleeptime):
    ...
    if os.path.isfile(filename):
        ...
        url = urlbase % specs
        url += FLAGS
        url += '&key=AIzaSyC7Fpq7GlNXsKTKS_2Lo4eJLeO6Df4k-2s'
        # url = 'https://maps.googleapis.com/maps/api/staticmap?center=Williamsburg,Brooklyn,NY&zoom=13&size=400x400&markers=color:blue%7Clabel:S%7C11211%7C11206%7C11222&format=jpg&key=AIzaSyCVFTZ8PbWr1h8t94ZVjv3HS6l13UKdcbQ'
...
class GooMPy(object):
    ...
    def __init__(self, width, height, latitude, longitude, zoom, maptype, radius_meters=None, default_ntiles=4):
        ...
        '''
        print(width , ' ' , height ,' ' , latitude , ' ' , longitude ,' ' , zoom , ' ' , maptype)
