		   ...
		   table2.addMouseListener(new MouseListener() {
				...
				public void mouseClicked(MouseEvent e) {
					...
					if (e.getButton() == MouseEvent.BUTTON1 && e.getClickCount() == 2)
					{
						...
						int branchID = Integer.parseInt(str); 
						...
						if (yes == 0)
						{
							try {
								...
								System.out.println(selectedBookID + ": You have borrowed the book!");
								OperateDatabase.borrowBook(selectedBookID, branchID, cardNo, stmt);
								f4.setVisible(false);
