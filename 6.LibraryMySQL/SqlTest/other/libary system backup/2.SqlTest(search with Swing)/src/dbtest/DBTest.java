...
public class DBTest {
    ...
    public static void main(String[] args)
    {
		...
		try {
			...
			//Call the Swing window for key words searching
			Swing w = new Swing();
			w.setVisible(true);
			while(true);
...
//			OperateDatabase.searchBook(stmt);//fuzzy search
...
//			System.out.println("Success!!");
    ...
    static void fuzzySearch(String isbn, String title, String author)
    {
    	try {
    		System.out.println(isbn + title + author);
			OperateDatabase.searchBook(isbn, title, author, stmt);
